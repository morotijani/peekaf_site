        ...
        <div class="off-canvas-sidebar">
            <div class="off-canvas-sidebar-wrapper">
                ...
                <div class="off-canvas-content">
                    ...
                    <aside class="widget widget-text">
                        <div class="textwidget">
                            <p class="text-center"><img src="assets/media/logo-1.png" alt="" width="80px"></p>
                            <p class="text-center">PeeKaf Company Limited is a registered company based in Ghana.</p>
                        </div>
                    </aside>
